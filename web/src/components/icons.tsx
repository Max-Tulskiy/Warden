// Stroke-based icons, one consistent style, matching the approved design
// canvas exactly (same paths as the mockups) so the built app is visually
// identical to what was designed, not a fresh interpretation of it.
...
export function StationsIcon({ size = 16 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function MediaIcon({ size = 12 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function PrintIcon({ size = 12 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function WebIcon({ size = 12 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ChevronRightIcon({ size = 12, color = "currentColor", style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      style={{ transition: "transform 0.15s", ...style }}
    >
      <path d="M9 6l6 6-6 6" />
    </svg>
  );
