    ...
    <AppShell>
      ...
      <form className="card report-filters" onSubmit={handleApply}>
        ...
        <p className="field-hint" style={{ margin: 0 }}>
          Журнал фиксирует изменения, входы и просмотры собранных данных и самого журнала.
          Запись о просмотре создаётся до выдачи данных, поэтому может попасть в собственный
          результат. Не фиксируются просмотр списка станций, политики и списка операторов,
          отклонённые запросы просмотра и отказы отключённой станции. Журнал не защищён от
          правки средствами базы данных: запись может изменить тот, у кого есть доступ к БД.
        </p>
      </form>
